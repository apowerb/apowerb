...
# Ownership moved to the core's `helpers/ownership.py` when evaluation became
# a commercial brick: "which agents are mine" is not an evaluation question,
# and the core's supervision still needs the answer. Re-exported so every
# existing import keeps working.
from apowerb.helpers.ownership import (  # noqa: E402
    is_admin,
    list_owned_agents,
...
# Re-exported on purpose: these names moved to the core when evaluation
# became a commercial brick, and every existing import site keeps working.
__all__ = [
    "EvaluatorSpec",
    "SessionContext",
