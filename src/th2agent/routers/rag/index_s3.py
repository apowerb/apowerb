...
from th2agent.tools_store.tools_helpers import set_tool_config_params_as_envvar
...
async def index_s3(
    ...
    from th2agent.tools_store.portfolio.s3_tools import _get_s3_client, _parse_s3_url
