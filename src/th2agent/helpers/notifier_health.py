...
The notifier (:mod:`th2agent.helpers.system_mailer`) sends from a shared mailbox
...
the :mod:`th2agent.scheduler.notifier_watch` loop. It NEVER raises.
"""
...
from th2agent.integrations.microsoft import MicrosoftIntegrationService
