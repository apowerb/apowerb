...
stores : importer ``th2agent.core.agent_main`` ou
``th2agent.tools_store.tools_helpers`` ouvrait une connexion et exécutait du
...
def ensure_store_tables() -> None:
    ...
    from th2agent.core.api_key_main import api_key_store
    from th2agent.core.hub_main import hub_store
    from th2agent.skills_store.skill_manager import skill_store
    from th2agent.tools_store.tools_helpers import tool_config_store
