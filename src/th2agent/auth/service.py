...
from th2agent.auth import exceptions, schemas
...
from th2agent.users.exceptions import UserNotFoundException
...
async def request_password_reset(
    ...
    html = system_mailer.render_branded_email(
        ...
        intro="Tu as demandé à réinitialiser ton mot de passe th2agent. "
...
async def send_verification_email(email: str, db: AsyncSession) -> None:
    ...
    html = system_mailer.render_branded_email(
        ...
        intro="Bienvenue sur th2agent. Confirme ton adresse pour activer ton compte.",
