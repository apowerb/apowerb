...
from th2agent.sqlgen.schema_format import build_schema_prompt
...
def _validate_sql_safety(sql_query: str) -> tuple[bool, Optional[str]]:
    """Backward-compat wrapper; logic lives in th2agent.sqlgen.safety."""
...
def _tool_business_analyst_impl(
    ...
    """
    from th2agent.sqlgen.analyst import run_investigation
...
def make_text_to_sql_tools(
    ...
    """
    from th2agent.core.agent_helpers import load_agent_model_params
