...
``th2agent.scheduler.run_agent_background`` with no change.
...
package, e.g.::
    ...
    patch("th2agent.scheduler.run_agent_background.get_agent_by_id")
...
from th2agent.core.adk_runner import run_adk_agent
