...
from th2agent.core.superagents.templates.rag import RAG_TEMPLATES
from th2agent.core.superagents.templates.data import DATA_TEMPLATES
from th2agent.core.superagents.templates.dashboard import DASHBOARD_TEMPLATES
from th2agent.core.superagents.templates.marketing import MARKETING_TEMPLATES
from th2agent.core.superagents.templates.image import IMAGE_TEMPLATES
from th2agent.core.superagents.templates.audio import AUDIO_TEMPLATES
