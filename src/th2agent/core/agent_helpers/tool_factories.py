...
from th2agent.core.agent_helpers.pdf_writer import _write_pdf
from th2agent.core.agent_helpers.read_file_tool import _make_read_uploaded_file
from th2agent.core.agent_helpers.ingest_file_tool import _make_ingest_file
from th2agent.core.agent_helpers.pdf_to_images_tool import _make_pdf_to_images
from th2agent.scheduler.backlog_status_tool import _make_get_backlog_status
...
def _make_upload_file(folder_name: str):
    ...
    def tool_upload_file(
        ...
        """
        import os
        from th2agent.tools_store.portfolio.onedrive import tool_upload_file as _upload
...
def _resolve_text_to_sql_tools(
    ...
    """
    from th2agent.tools_store.portfolio.text_to_sql import make_text_to_sql_tools
