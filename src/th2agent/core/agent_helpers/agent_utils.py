...
from th2agent.helpers.encryptor import decrypt_value_in_dict, dict_to_envvar
from th2agent.tools_store.tools_helpers import load_agent_tools_functions
...
from th2agent.core.agent_helpers.text_utils import _escape_template_vars
from th2agent.core.agent_helpers.mcp_loader import (
    build_mcp_instruction_preamble,
    load_mcp_servers,
)
from th2agent.core.agent_helpers.llm_model_builder import (
    build_litellm_model,
    apply_output_schema,
)
...
from th2agent.core.agent_helpers.extras_loader import (
...
def to_agent(agent_name: str) -> LlmAgent:
    ...
    # See th2agent.tools_store.portfolio.google_auth._ensure_integration_tokens
    # and th2agent.core.invocation_context.
    ...
    if agent_type == "sequential":
        ...
        if superagent_template_id:
            from th2agent.core.superagents import get_superagent_template as _get_tpl
