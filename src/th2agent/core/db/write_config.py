...
def select_write_config(
    ...
    *,
    ...
    if _list_configs is None:
        from th2agent.tools_store.tools_helpers import list_user_tool_configs as _list_configs
    if _parse_ops is None:
        from th2agent.tools_store.portfolio.database import _parse_allowed_ops as _parse_ops
