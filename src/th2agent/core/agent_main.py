...
from th2agent.core.adk_agent_builder import create_agent_module, delete_agent_module
...
from th2agent.core.superagents import compute_template_hash
from th2agent.helpers.encryptor import encrypt_value_in_dict, decrypt_value_in_dict
...
def get_agent_template_status(agent_id: int, user_id: str) -> dict:
    ...
    """
    from th2agent.core.superagents import diff_agent_against_template
    ...
    for sub_id_str in sub_agent_ids:
        ...
        if raw_mcp:
            ...
            if isinstance(raw_mcp, list):
                from th2agent.schema.agent_schema import McpServerConfig
